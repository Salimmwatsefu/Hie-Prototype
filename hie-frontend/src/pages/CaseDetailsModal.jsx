...
export default function CaseDetailsModal({ fraudCase, onClose }) {
  ...
  return (
    <Dialog open={!!fraudCase} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Case Details: {fraudCase.patient_id}</DialogTitle>
        </DialogHeader>
        <div className="space-y-2 mt-4">
          ...
          <p><strong>Date:</strong> {new Date(fraudCase.created_at).toLocaleDateString()}</p>
        </div>
